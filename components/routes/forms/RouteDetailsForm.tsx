...
const RouteDetailsForm = ({ 
  ...
  isRouteKeyEditable = false // Default to not editable
    ...
    <View style={styles.routeDetailsSection}>
      ...
      <View style={styles.formRow}>
        ...
        <View style={[styles.formGroup, { flex: 1, marginLeft: 8 }]}>
          <View style={styles.formLabelContainer}>
            <ThemedText style={styles.formLabel}>Route Code</ThemedText>
          ...
          >
            <TextInput
              ...
              value={routeKey}
              readOnly={true}
              editable={isRouteKeyEditable}
              onChangeText={(text) => {
                if (isRouteKeyEditable) {
                  setRouteKey(text);
                  if (text.trim()) {
      ...
      {/* Calculated timing section with Use Estimated Time button */}
        ...
        <View style={styles.timingSummary}>
          ...
          <View style={styles.timingDetails}>
            ...
            <TouchableOpacity
              ...
              onPress={() => setEndTime(calculatedEndTime)}
            >
              <ThemedText style={{ color: 'white', fontSize: 12, fontWeight: '500' }}>
                Use Estimated Time
              </ThemedText>
            </TouchableOpacity>
          </View>
