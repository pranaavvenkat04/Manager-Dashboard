...
import { LayoutDashboard, Car, Map, Users, Bell, HelpCircle, Settings, User, LogOut, School, Gauge } from 'lucide-react';
...
const BOTTOM_ROUTES: RouteItem[] = [
  { path: '/school-map', icon: School, label: 'School Information' },
